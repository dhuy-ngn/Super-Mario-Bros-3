...
#define ID_SPRITE_MARIO_RACCOON_LAND (ID_SPRITE_MARIO_RACCOON + 700)
#define ID_SPRITE_MARIO_RACCOON_LAND_LEFT (ID_SPRITE_MARIO_RACCOON_JUMP + 10)
#define ID_SPRITE_MARIO_RACCOON_LAND_RIGHT (ID_SPRITE_MARIO_RACCOON_JUMP + 20)

#define ID_SPRITE_MARIO_RACCOON_FLY (ID_SPRITE_MARIO_RACCOON + 800)
#define ID_SPRITE_MARIO_RACCOON_LAND_LEFT (ID_SPRITE_MARIO_RACCOON_JUMP + 10)
#define ID_SPRITE_MARIO_RACCOON_LAND_RIGHT (ID_SPRITE_MARIO_RACCOON_JUMP + 20)
...
#pragma region WOOD
#define ID_SPRITE_WOOD 60000

#define ID_SPRITE_WOOD_TOP (ID_SPRITE_WOOD + 1000)
#define ID_SPRITE_WOOD_TOP_BEGIN (ID_SPRITE_WOOD_TOP + 100)
#define ID_SPRITE_WOOD_TOP_MIDDLE (ID_SPRITE_WOOD_TOP + 200)
#define ID_SPRITE_WOOD_TOP_END (ID_SPRITE_WOOD_TOP + 300)

#define ID_SPRITE_WOOD_BOTTOM (ID_SPRITE_WOOD + 2000)
#define ID_SPRITE_WOOD_BOTTOM_BEGIN (ID_SPRITE_WOOD_BOTTOM + 100)
#define ID_SPRITE_WOOD_TOP_BEGIN (ID_SPRITE_WOOD_BOTTOM + 200)
#define ID_SPRITE_WOOD_TOP_BEGIN (ID_SPRITE_WOOD_BOTTOM + 300)
